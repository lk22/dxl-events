<div class="dxl dxl-events events-container">
    <div class="header">
        ...
        <div class="actions">
            <a href="#" class="button-primary modal-button" data-modal="#createLanEventModal">Opret begivenhed <span class="dashicons dashicons-calendar"></span></a>
        </div>
    </div>
...
<div class="modal createLanEventModal hidden" id="createLanEventModal">
